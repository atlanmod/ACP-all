...
# TODO relations 
exclu = [((6, 7), [[-1, 0], [0, -1]]), ((8, 9), [[-1, 0], [0, -1]]), ((10, 11), [[-1, 0], [0, -1]]),
          ((10, 9), [[-1, 0], [0, -1]]), ((16, 17), [[-1, 0], [0, -1]]), ((27, 28), [[-1, 0], [0, -1]])]
exclu1 = [((6, 8), [[0, -1], [-1, 1]]), ((6, 9), [[0, -1], [-1, 1]]), ((7, 8), [[0, -1], [-1, 1]]),
           ((7, 16),  [[0, -1], [-1, 1]])]
exclu2 = [((7, 9), [[-1, 0], [1, -1]])]
exclu3 = [((6, 7), [[-1, 1], [1, -1]]), ((8, 9), [[-1, 1], [1, -1]])]

ALLOWED = gener_allowed(exclu + exclu1 + exclu2 + exclu3, len(REQ))
print(str(len(ALLOWED)) + " " + str(ALLOWED)) # 8192
ALLOWED = minimizing(ALLOWED)
print(str(len(ALLOWED)) + " " + str(ALLOWED)) # 8
